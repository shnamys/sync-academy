		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Product Program (11)",
									"targetURL": "#examexprogram11-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"examexprogram11-display": {
								"semanticObject": "examexprogram11",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exam.exprogram11",
									"url": sap.ui.require.toUrl("exam/exprogram11")
								}
							}
						}
					}
