					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[SYNC_REST-FI] 전표 승인",
									"targetURL": "#project1121-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"project1121-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project1121",
									"url": sap.ui.require.toUrl("project1121")
								}
							}
						}
					}
