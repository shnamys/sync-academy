					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[SYNC_REST-FI] 매출/매입 조회",
									"targetURL": "#project1118-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"project1118-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project1118",
									"url": sap.ui.require.toUrl("project1118")
								}
							}
						}
					}
