		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OData CRUD",
									"targetURL": "#odataproject1113-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"odataproject1113-display": {
								"semanticObject": "odataproject1113",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=odata.project1113",
									"url": sap.ui.require.toUrl("odata/project1113")
								}
							}
						}
					}
