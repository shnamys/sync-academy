					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[SYNC_REST-FI] 매출/매입 현황 조회",
									"targetURL": "#project1120-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"project1120-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project1120",
									"url": sap.ui.require.toUrl("project1120")
								}
							}
						}
					}
