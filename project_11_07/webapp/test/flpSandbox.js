		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Model",
									"targetURL": "#syncproject1107-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncproject1107-display": {
								"semanticObject": "syncproject1107",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.project1107",
									"url": sap.ui.require.toUrl("sync/project1107")
								}
							}
						}
					}
